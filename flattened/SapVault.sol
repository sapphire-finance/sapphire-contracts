...
interface IMasterChef {
    ...
    function pendingSap(uint256 _pid, address _user) external view returns (uint256);
...
contract SapVault is Ownable, Pausable {
    ...
    /**
     * @notice Deposits funds into the Sap Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in SAP)
     */
    ...
    /**
     * @notice Reinvests SAP tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Sap Vault
     */
     ...
     * @return Expected reward to collect in SAP
     */
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingSap(0, address(this));
     ...
     * @return Returns total pending sap rewards
     */
    ...
    /**
     * @notice Withdraws from funds from the Sap Vault
