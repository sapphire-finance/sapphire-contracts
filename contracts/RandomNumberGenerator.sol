...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public candySwapLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == candySwapLottery, "Only CandySwapLottery");
    ...
    /**
     * @notice Set the address for the CandySwapLottery
     * @param _candySwapLottery: address of the CandySwap lottery
     */
    function setLotteryAddress(address _candySwapLottery) external onlyOwner {
        candySwapLottery = _candySwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ICandySwapLottery(candySwapLottery).viewCurrentLotteryId();
    }
}
